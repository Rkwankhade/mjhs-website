  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-xl border border-border bg-card p-6 shadow-card-hover animate-scale-in',
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title ref={ref} className={cn('font-serif text-lg font-semibold', className)} {...props} />
));
